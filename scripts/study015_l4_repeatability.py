...
This is an integration-conformance proof, not a performance experiment.
...
ATTEMPT = "attempt/study015/live-2"
EFFECT = "effect/study015/live-2"
CAUSAL = "causal/study015/live-2"
TARGET_REPO = "Aftergraph/runtime"
TARGET_BRANCH = "study015/l4-repeatability-proof-target"
    ...
    with tempfile.TemporaryDirectory(prefix="study015-live-causal-") as td:
        ...
        try:
            ...
            dispatch_request = {
                ...
                "attemptId": ATTEMPT,
                "effectId": EFFECT,
                "idempotencyKey": "idem/study015/live-2",
                "budgetRef": "budget/study015/live-2",
                "budgetCeiling": 100,
                "checkpointId": "checkpoint/study015/live-2",
                "evidenceRoot": "evidence/study015/live-2",
                "causalId": CAUSAL,
            }
            ...
            args = {
                ...
                "effect_id": EFFECT,
                "causal_id": CAUSAL,
                "request_id": "req/study015/live-2",
            ...
            # L4 repeatability invariant: a fresh run must not accept identity
            # minted by the verified L3 run.
            prior_l3_context = "ctx_c25bcc01cd7b21ed26826f1666847208"
            old_identity = dict(acceptance_body)
            old_identity["execution_context_id"] = prior_l3_context
            ...
            if old_identity_status != 409:
                raise ProofError("L3 execution context replay bound into L4 acceptance")
            ...
            receipt = {
                "schema": "study015.l4-repeatability/1.0",
                "execution_class": "LIVE_INTEGRATION_CONFORMANCE",
                "evidence_class": "L4_INDEPENDENT_REPEATABILITY_CANDIDATE",
                ...
                "repeatability": {
                    ...
                    "prior_l3_exact_subject": "git:Aftergraph/runtime@9c781f624bae36ee35aa23df57060e934d3a634c",
            ...
            if not all(receipt["repeatability"].values()):
                raise ProofError("L4 fresh-identity repeatability invariant failed")
