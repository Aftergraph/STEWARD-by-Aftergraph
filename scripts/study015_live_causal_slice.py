#!/usr/bin/env python3
"""STUDY-015 LIVE_CAUSAL_SLICE / L3.
...
ATTEMPT = "attempt/study015/live-1"
EFFECT = "effect/study015/live-1"
CAUSAL = "causal/study015/live-1"
TARGET_REPO = "Aftergraph/runtime"
TARGET_BRANCH = "study015/live-causal-proof-target"
    ...
    with tempfile.TemporaryDirectory(prefix="study015-live-causal-") as td:
        ...
        try:
            ...
            dispatch_request = {
                ...
                "attemptId": ATTEMPT,
                "effectId": EFFECT,
                "idempotencyKey": "idem/study015/live-1",
                "budgetRef": "budget/study015/live-1",
                "budgetCeiling": 100,
                "checkpointId": "checkpoint/study015/live-1",
                "evidenceRoot": "evidence/study015/live-1",
                "causalId": CAUSAL,
            }
            ...
            args = {
                ...
                "effect_id": EFFECT,
                "causal_id": CAUSAL,
                "request_id": "req/study015/live-1",
            ...
            receipt = {
                "schema": "study015.live-causal-slice/1.0",
                "execution_class": "LIVE_INTEGRATION_CONFORMANCE",
                "evidence_class": "L3_COMPOSITION_CONFORMANCE_CANDIDATE",
